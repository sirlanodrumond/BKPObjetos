...
--              V_CONDESPECIAIS := 'RECEBER COMISSÃO S/BONUS DE R$ ' || TRIM(TO_CHAR(v_Bonus,'999,999,990.00')) || ' NA PONTA SE ENTR.NO DIA COMBINADO, PAGAMENTO AUTORIZADO SOMENTE NAS FILIAIS';
