...
--       Exemplo MSG=LISTNOTA;MINUTA=9876459871;GRUPO=0535
     ...
     --Exemplo de QryString = MSG=LISTNOTA;MINUTA=0549686301
        ...
        if vPlaca <> 'VFERRADO' Then
           ...
           vMessage := vMessage || 'http://extranet.dellavolpe.com.br:6917/gerplanilha/get/result?codigoPlanilha=romValeSAC' || 
                ...
                Begin -- Inicio do disparo dos EMAIL´s
                 If ( vAchou > 0 ) and ( nvl(vEmail,'a') <> 'sdrumond@dellavolpe.com.br' ) Then
                    ...
                    loop
                       ...
                       Else
                          vEmailCopia := 'romaneiolog@dellavolpe.com.br';
                          
                          If vGrupo in ('0599','0633') Then
                             vEmailCopia := vEmailCopia || ';larissa.silva@dellavolpe.com.br;carolina.pereira@dellavolpe.com.br';
                          End If;
