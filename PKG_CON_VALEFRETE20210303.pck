       ...
       --                                                                 'P'),
                  ...
                  vFreteBruto := 0;
                    ...
                    if (vVfFrota = false) then
                       ...
                       -- Sirlano 08/03/2021
                       -- Para zerar quando e Vale Pedadio
                       If ( nvl(vValeFrete.Con_Valefrete_Pgvpedagio,'N') = 'S' ) and 
                          ( nvl(vValeFrete.Con_Valefrete_Pedpgcli,'N')   = 'S' ) Then
 ...
 */
 ...
 pkg_con_valefrete.vProcValidaValeFrete := 'N';
   ...
   If lpad(P_CON_CATVALEFRETE_CODIGO,2,'0') not in ('01','02','09') Then
      v_bloqueios := 0;
   End If;   
