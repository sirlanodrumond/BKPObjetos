...
SELECT DISTINCT T.GLB_FORNECEDOR_CGCCPF   FORN,
       T.CPG_TITULOS_COMPETENCIA DATA,
       --VINICIUS/SIRLANO 07/01/2022 - Retirada a coluna pois estava causando duplicidade de titulo (adicionado o distinct).
...
--       DECODE(T.CPG_TITULOS_TIPOTITULO,'I',REPLACE(F.GLB_FORNECEDOR_CPGPCONTA,'***',R.GLB_ROTA_CODGENBAL),SUBSTR(REPLACE(E.CTB_PCONTA_CODIGODEB,'BBBBB','00'||TRIM(B.GLB_BANCO_NUMERO)),1,12))  CDEB,
       -- Sirlano / Joao
       -- 21/10/2021
       -- Implementado um '3' antes do Banco quando for o Banco codigo 399
