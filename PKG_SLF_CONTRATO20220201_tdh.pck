...
/* Feito por: João Henrique
   Data: 17/01/2021
   Descrição: Para esse contrato, se na entrada da nota for o tipo de carga "Carga Avulsa" com os armazéns(('06','15','07')
    e o pagador for o remetente, eu altero o tipo de carga para FRACIONADO RE(12)*/

Elsif (vContrato = 'C7000067442') Then
   vAuxiliar := 0;
   
          select count(*) 
            into vAuxiliar
            from tdvadm.t_arm_nota nf 
           where nf.arm_nota_numero = pNota
             and nf.glb_cliente_cgccpfremetente = pCNPJ
             and nf.glb_cliente_cgccpfremetente = nf.glb_cliente_cgccpfsacado
             and nf.arm_armazem_codigo in('06','15','07')
             and nf.glb_tpcarga_codigo = 'FF';
   
  
  if (vAuxiliar <> 0)Then
    
         update tdvadm.t_arm_nota ng
            set ng.Glb_Tpcarga_Codigo = '12'
          where ng.arm_nota_numero = pNota
            and ng.glb_cliente_cgccpfremetente = pCNPJ;
        
         update tdvadm.t_arm_coleta co
            set co.fcf_tpcarga_codigo = '12'
          where co.arm_coleta_ncompra = vColeta
            and co.arm_coleta_ciclo = vCiclo;
  ...
  End if;     
      ...
      Elsif vContrato in ('C2020030005', -- LOT-CARAIBA-0320-XXX
                          ...
                          'C2021020001') Then --  Adicionado conforme chamado 187683 
...
/*      Elsif vContrato in ('C2020070004') Then --LOT-GE-0720-XXX
     ...
     --Vinicius Dantas C2021060003 08/07/2021 obrigatoriedade pedido nota
      ...
      ElsIf vContrato in ('C2021060003') -- SOLTEC
        then       
