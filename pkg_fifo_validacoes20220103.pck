...
*/  
        ...
        for c_msg in (Select nota.arm_embalagem_numero, 
          ...
          Loop 
            ...
            If Trim( pkg_fifo_carregamento.FN_Get_OrigtEmbalagem(c_msg.arm_embalagem_numero,
                                                                 c_msg.arm_embalagem_flag,
                                                                 c_msg.arm_embalagem_sequencia,
                                                                 'I'  ) ) = Trim(fn_busca_codigoibge(vCursor.Glb_Localidade_Codigo,'IBC')) Then
               vControl := vControl + 1;
            End If;                                                     
           End Loop;
