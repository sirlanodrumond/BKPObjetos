                       ...
                       If ( nvl(tpVfreteentregas.Con_Vfreteentrega_Dtentrega,'01/01/1900') <> plistaVFEntregas(tpVF.vAuxiliar).con_vfreteentrega_dtentrega ) or
                        ...
                        Elsif (tpVfreteentregas.Con_Vfreteentrega_Confirmado is null) and
                              ...
                              WHERE VF.con_conhecimento_codigo = CO.CON_CONHECIMENTO_CODIGO AND
                                    ...
                                    CLI.GLB_CLIEND_CODCLIENTE = plistaVFEntregas(tpVF.vAuxiliar).CON_VFRETEENTREGA_CODCLI AND
                              ...
                              If  Fn_VerificaObrigacaoDigCodOrigem(pListaParams, vGrupoEconomico)  AND (NVL(plistaVFEntregas(tpVF.vAuxiliar).Con_Vfreteentrega_Codigo, 'x') = 'x')  Then                                    
                                   P_STATUS :=  'E';
                                   P_MESSAGE := 'Campo Código de Entrega não foi preenchido.';
