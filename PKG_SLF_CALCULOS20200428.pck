...
--  COLOCAR NA TRIGGER 
 ...
 vListaCNPJcomDestaqueICMS varchar2(200) := '17469701010482;17469701001653;17469701005306;17469701008232;83249078000171;36785418001502;60643228061503';
  ...
  BEGIN
    ...
    --WHO_CALLED_ME2;
     ...
     -- IF V_RPS <> 'S' THEN 
        ...
        IF V_GLB_ROTA not in ('194','571','230','000') THEN
...
--                                            V_TIPOCALCULOSEQ || '-'||V_DESINENCIA || ' - ' ||  V_FORMULA_CALC || ' - ' || V_FORMULA_CALCTRATADA||' Valor '|| V_VALOR_FORMULA|| ' verba result '||v_verbaresultado);
      ...
      If  (TRIM(V_VERBARESULTADO) = 'I_VLICMS') or
          (TRIM(V_VERBARESULTADO) = 'I_VLISS'  and vROTA_CODIGO not in ('028','031') )  THEN
        UPDATE T_CON_CALCCONHECIMENTO
