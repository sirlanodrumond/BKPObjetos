...
*/
   ...
   Begin
            ...
            if ( tpRecebido.glb_benasserec_origem = 'tdv.spfaturamento1@dellavolpe.com.br' ) or
               ...
               ( tpRecebido.glb_benasserec_origem  = 'andre.oliveira@dellavolpe.com.br' )
             Then
...
--       Exemplo MSG=LISTNOTA;MINUTA=9876459871;GRUPO=0535
        ...
        if vQryString is null Then
           vQryString := 'MSG=LISTNOTA;MINUTA=7480371971;GRUPO=0535';
           pTpRecebido.GLB_BENASSEREC_ASSUNTO := 'MSG=LISTNOTA;MINUTA=7480371971;';
           vEmail := 'sdrumond@dellavolpe.com.br;bbernardo@dellavolpe.com.br';
        End If;  
        ...
        if pTpRecebido.glb_benasserec_origem <> 'aut-e@dellavolpe.com.br' Then
