...
--       sp_LePlanilha(pXLS,vCursor);
      ...
      exception
         When OTHERS Then
            -- sirlano
            -- 19/11/2021 - Critica do erro
            raise_application_error(-20111,'Arquivo ' || upper(pXLS) || 'Verificar ' || chr(13) || sqlerrm);
      End;
                  ...
                  if vLinha.TABELA is NOT Null Then
                     ...
                     Exception
                       ...
                       When Others Then
                          pStatus := 'E';
                          vMostraErro := 'S';
                          vErro :=  vErro || pkg_glb_html.fn_ItensLista('[' || vLinha.TABELA  || '] - erro : ' || sqlerrm);
                       End ;
                  Else
                     -- Procura qual tabela Atende esta regra.
                     Begin
