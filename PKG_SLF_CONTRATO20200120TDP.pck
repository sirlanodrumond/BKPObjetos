...
/*      ElsIf (vContrato = 'C2018010117') Then
        ...
        ElsIf (vTipoCarga = 'FF') Then
          update t_arm_coleta co
           ...
           where co.arm_coleta_ncompra = vColeta
             and co.arm_coleta_ciclo = vCiclo;
        End If;
      ElsIf (vContrato in ('C7000067442', -- MRO-USIMINAS -0118-XXX
                           'C4600155674') -- SOLUÇÕES EM AÇO USIMINAS S/A
            ) Then
      ...
      ElsIf (vContrato in ('C4600006653') -- MRO-USI MECANICA-0318-XXX
            ) Then
        If vLocDestino in ('05571', -- Armazem SP
                           '32001', -- Armazem MG
                           '20000' -- Armazem RJ
