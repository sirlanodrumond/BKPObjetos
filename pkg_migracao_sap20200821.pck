...
begin
    ...
    LOOP
        ...
        If ( nvl(vcursor.lifnr,'n') <> 'n' ) and ( vCursor.WRBTR > 0 ) Then                         
            ...
            tpOPEN_ITEM_AP_S_BSIK.SGTXT := substr(vCursor.SGTXT,1,50) ; -- Obrigatório(N) - Texto do item
            ...
            If instr(tpOPEN_ITEM_AP_S_BSIK.SGTXT,',(') = 0 Then
               tpOPEN_ITEM_AP_S_BSIK.SGTXT := substr(replace(tpOPEN_ITEM_AP_S_BSIK.sgtxt,',ADT,',',(ADTO),'),1,50);
               tpOPEN_ITEM_AP_S_BSIK.SGTXT := substr(replace(tpOPEN_ITEM_AP_S_BSIK.sgtxt,',SDO,',',(SDO),'),1,50);
               tpOPEN_ITEM_AP_S_BSIK.SGTXT := substr(replace(tpOPEN_ITEM_AP_S_BSIK.sgtxt,',PED,',',(PED),'),1,50);
               tpOPEN_ITEM_AP_S_BSIK.SGTXT := substr(replace(tpOPEN_ITEM_AP_S_BSIK.sgtxt,',PD,',',(PD),'),1,50);
               tpOPEN_ITEM_AP_S_BSIK.SGTXT := substr(replace(tpOPEN_ITEM_AP_S_BSIK.sgtxt,',AD,',',(AD),'),1,50);
               tpOPEN_ITEM_AP_S_BSIK.SGTXT := substr(replace(tpOPEN_ITEM_AP_S_BSIK.sgtxt,',TR,',',(TR),'),1,50);
               tpOPEN_ITEM_AP_S_BSIK.SGTXT := substr(replace(tpOPEN_ITEM_AP_S_BSIK.sgtxt,',SD,',',(SD),'),1,50);
               tpOPEN_ITEM_AP_S_BSIK.SGTXT := substr(replace(tpOPEN_ITEM_AP_S_BSIK.sgtxt,',SALDO,',',(SD),'),1,50);
               tpOPEN_ITEM_AP_S_BSIK.SGTXT := substr(replace(tpOPEN_ITEM_AP_S_BSIK.sgtxt,',SDOCT',',(SDO),CT,'),1,50);
               tpOPEN_ITEM_AP_S_BSIK.SGTXT := substr(replace(tpOPEN_ITEM_AP_S_BSIK.sgtxt,',TRCT',',(TR),CT,'),1,50);
            End If;
                                                             

            select substr(tpOPEN_ITEM_AP_S_BSIK.SGTXT,instr(tpOPEN_ITEM_AP_S_BSIK.SGTXT,'('),decode(instr(tpOPEN_ITEM_AP_S_BSIK.SGTXT,')',20),0,25,instr(tpOPEN_ITEM_AP_S_BSIK.SGTXT,')',20))-19)
                into vAuxiliar
            from dual;

            If vAuxiliar in ('(FRETE)','(FRETE),') Then
               vChaveTDV     := substr(tpOPEN_ITEM_AP_S_BSIK.SGTXT,1,18);
               vChaveDocBase := tpOPEN_ITEM_AP_S_BSIK.XBLNR;
               vValorBase    := tpOPEN_ITEM_AP_S_BSIK.WRBTR;
            End If;  
