create or replace package migdv.pkg_migracao_sap3 is
...
end pkg_migracao_sap3;
/
CREATE OR REPLACE PACKAGE BODY MIGDV.pkg_migracao_sap3 IS
...
begin
    ...
    LOOP
        ...
        tpOPEN_ITEM_AP_S_BSIK.LIFNR := migdv.pkg_migracao_sap3.fn_busca_codigoSAP(vCursor.car_proprietario_cgccpfcodigo,'CAR') ; -- Obrigatório(S) - Identificador do Fornecedor*
...
begin
    ...
    LOOP
        ...
        tpOPEN_ITEM_AR_S_BSID.KUNNR := migdv.pkg_migracao_sap3.fn_busca_codigoSAP(vCursor.glb_cliente_cgccpfcodigo,'CLI') ; -- Obrigatório(S) - Identificador do Cliente
