         ...
         If ( tpVF.VFAcao = cSalvar ) Then 
          Begin
            ...
            If sql%rowcount = 0 Then
               ...
               tplinhaVfretepedagio.Glb_Fornecedor_Cgccpf    := Glbadm.pkg_glb_WsInterfaceDB.Fn_GetParam( tpVF.vXmlTab,'vfornecedor' );
               tplinhaVfretepedagio.Glb_Cliente_Cgccpfcodigo := Glbadm.pkg_glb_WsInterfaceDB.Fn_GetParam( tpVF.vXmlTab,'vpagador' );
