  ...
  Begin
    Begin
      ...
      Select ap.usu_aplicacao_path
        ...
        Where Lower(ap.usu_aplicacao_codigo) = Lower(pkg_glb_MenuTdv.CODIGO_MENU);    
  ...
  Begin
    ...
    Begin
      ...
      Select 
             ...
             ap.usu_aplicacao_dataversao
      From tdvadm.t_usu_aplicacao ap
      Where trim(lower(ap.usu_aplicacao_codigo)) = trim(lower(pkg_glb_menutdv.CODIGO_LOGIN))
      And rownum = 1;
  ...
  begin
    ...
    begin
      ...
      SELECT * 
       ...
       WHERE 0=0
         and trim(lower(a.USU_APLICACAO_CODIGO)) = trim(lower(pAppCodigo)); 
  ...
  begin
    begin
      ...
      SELECT TRIM(nvl(A.USU_APLICACAO_VERSAO,VERSION_NOT_FOUND))
       ...
       WHERE lower(trim(A.USU_APLICACAO_CODIGO)) = lower(trim(pAppCod));      
  ...
  begin  
    ...
    begin
      ...
      SELECT DISTINCT USU_SEGMENTO_NOMEMENU 
       ...
       WHERE  0=0
         and lower(trim(V.Usu_Usuario_Codigo)) = lower(trim(pUser))
       order by 1;
    ...
    begin
      ...
      SELECT COUNT(*)
       ...
       WHERE 0=0 
         ...
         AND LOWER(trim(U.USU_USUARIO_CODIGO)) = LOWER(trim(pUser));
    ...
    begin             
      ...
      SELECT distinct TRIM(F.USU_APLICACAO_CODIGO) APP_CODE,
       ...
       WHERE A.USU_APLICACAO_CODIGO = F.USU_APLICACAO_CODIGO
         ...
         AND lower(trim(F.USU_USUARIO_CODIGO)) = lower(trim(pUser))
        order by case 
  ...
  begin
    begin
      ...
      SELECT count(*)
        ...
        FROM T_USU_USUARIO U
       WHERE 0=0
         and TRIM(lower(USU_USUARIO_CODIGO)) = lower(trim(pCodigo));
      ...
      SELECT U.USU_USUARIO_CODIGO,
       ...
       WHERE 0=0 
         --and TRIM(lower(USU_USUARIO_CODIGO)) = lower(trim(vCodigo))        
         and TRIM(lower(U.USU_USUARIO_CODIGO)) = lower(trim(pCodigo))
         and trim(lower(U.USU_USUARIO_CODIGO)) = lower(trim(I.INT_MAQUINAS_OSUSER(+)))
    ...
    begin     
      ...
      SELECT NVL(USU_USUARIO_TPPESSOA,'X')
       ...
       WHERE 0=0
         ...
         and lower(trim(USU_USUARIO_CODIGO)) = lower(trim(pCodigo));
  ...
  begin
    begin     
      ...
      SELECT U.USU_USUARIO_CPF
        ...
        FROM T_USU_USUARIO U
       WHERE 0=0 
         and trim(lower(U.USU_USUARIO_CODIGO)) = trim(lower(vCodigo));
...
/*    pXmlOut := '<Parametros><Output>'||
  ...
  begin
    begin
      ...
      SELECT USU_APLICACAO_DESCALTERACAO 
        into pDescricao
        FROM T_USU_APLICACAO
       WHERE lower(trim(USU_APLICACAO_CODIGO)) = lower(pkg_glb_MenuTdv.CODIGO_MENU);
  ...
  begin
    begin
      ...
      UPDATE T_USU_USUARIO U 
       ...
       WHERE lower(trim(U.USU_USUARIO_CODIGO)) = lower(trim(pUsuario));      
    ...
    begin
      open pCursor for
       SELECT NVL(U.USU_USUARIO_CODIGO,' '),
         ...
         FROM T_USU_USUARIO U
        where 0=0
          and trim(lower(USU_USUARIO_CODIGO)) = trim(lower(pUsuario));
  ...
  begin
    begin
      UPDATE T_USU_USUARIO U
       ...
       WHERE 0=0
         and trim(lower(U.USU_USUARIO_CODIGO)) = lower(trim(pUsuario));
  ...
  begin
    begin
      ...
      SELECT nvl(trim(U.USU_USUARIO_CPF),null)
        ...
        FROM T_USU_USUARIO U
       WHERE 0=0 
         and trim(lower(U.USU_USUARIO_CODIGO)) = trim(lower(pUsuario));
  ...
  begin
    begin
      SELECT US.USU_USUARIO_DICA
       ...
       WHERE 0=0
         and lower(trim(US.USU_USUARIO_CODIGO)) = lower(trim(pUsuario))
  ...
  begin
    begin
      ...
      UPDATE T_USU_USUARIO
       ...
       WHERE lower(trim(USU_USUARIO_CODIGO)) = lower(trim(pUsuario)); 
  ...
  begin
    begin
      ...
      UPDATE T_USU_USUARIOPERFIL
         SET USU_USUARIOPERFIL_DTULTUTILIZA = SYSDATE
       WHERE lower(trim(USU_APLICACAO_CODIGO)) = lower(trim(pApplication))
         and lower(trim(USU_USUARIO_CODIGO))   = lower(trim(pUsuario));
  ...
  begin
    begin  
      ...
      DELETE 
       ...
       WHERE lower(trim(F.USU_USUARIO_CODIGO)) = lower(trim(pUsuario))
         AND lower(trim(F.USU_APLICACAO_CODIGO)) = lower(trim(pApplication));    
    ...
    begin
      ...
      delete from t_glb_ambienteusuario au
       where 0=0
         ...
         and lower(trim(au.terminal)) = lower(trim(vMaquina));
      commit;
  ...
  begin  
    ...
    begin
      ...
      SELECT distinct v.USU_SEGMENTO_NOMEMENU,
        ...
        FROM V_USU_USUARIOPERFIL_MNOVO V
      WHERE 0=0
        and lower(trim(V.USU_MODULO_NOMEMENU)) = lower(trim(pModulo)) 
  ...
  begin
    begin
      ...
      select ap.usu_aplicacao_versao 
        ...
        from tdvadm.t_usu_aplicacao ap
       where 0=0
         and lower(trim(ap.usu_aplicacao_codigo)) = lower(trim(pkg_glb_MenuTdv.CODIGO_MENU));
         
      select ap.usu_aplicacao_versao 
        into vVersaoDBLogin
        from tdvadm.t_usu_aplicacao ap
       where 0=0
         and lower(trim(ap.usu_aplicacao_codigo)) = lower(trim(pkg_glb_MenuTdv.CODIGO_LOGIN));
...
End fn_EncriptaSenha;
  ...
  begin
   ...
   begin
      ...
      select ap.usu_aplicacao_versao 
        ...
        from tdvadm.t_usu_aplicacao ap
       where 0=0
         and lower(trim(ap.usu_aplicacao_codigo)) = lower(trim(pkg_glb_MenuTdv.CODIGO_ATUALIZA));        
  ...
  begin
    ...
    begin      
      ...
      from tdvadm.t_usu_usuario u
      where 0=0
      and lower(trim(u.usu_usuario_codigo)) = lower(trim(pUsuario));      
    exception when others then
